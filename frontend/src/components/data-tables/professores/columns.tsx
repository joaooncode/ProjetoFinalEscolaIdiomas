...
export const columns: ColumnDef<Professor>[] = [
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem
              onClick={() =>
                navigator.clipboard.writeText(professor.id.toString())
              }
  ...
  },
  {
    ...
    cell: ({ row }) => {
      const nomeCompleto = `${row.original.nome} ${
        row.original.sobrenome || ""
      }`.trim();
      return <div className="font-medium text-foreground">{nomeCompleto}</div>;
    },
  ...
  },
  {
    ...
    cell: ({ row }) => {
      return (
        <div className="text-muted-foreground">{row.original.formacao}</div>
      );
    },
